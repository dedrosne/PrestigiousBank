...
{
    public static class AltdorfBankMenu
    {
        ...
        public static void CreateOrUpdateGameMenuDesc(CampaignGameStarter campaignGameStarter)
        {
            ...
            string clientLevelString = AltdorfBankCampaignBehavior.BankAltdorf.GetCustomerLevelString();//TODOW
            int currentSolde = AltdorfBankCampaignBehavior.BankAltdorf.Solde;
            float interestRatePercentage = AltdorfBankCampaignBehavior.BankAltdorf.CalculateInterestRate()*100f;
            int prestigiousSolde = AltdorfBankCampaignBehavior.BankAltdorf.prestigiousAccountSolde;
            int prestigiousInterests = AltdorfBankCampaignBehavior.BankAltdorf.CalculatePrestigiousInterests();
            // Bank Menu
            campaignGameStarter.AddGameMenu("altdorf_bank_menu",
                String.Format("Bienvenue à la banque d'Altdorf.\nNiveau du client : {0}\nSolde : {1}\nTaux d'intérêts : {2}%/jour", clientLevelString, currentSolde,interestRatePercentage.ToString("G3")),
                null, TaleWorlds.CampaignSystem.Overlay.GameOverlays.MenuOverlayType.SettlementWithCharacters); //TODOW

            //AccountMenu
            campaignGameStarter.AddGameMenu("altdorf_account", String.Format("Solde : {0}\nTaux d'intérêts : {1}%/jour", currentSolde, interestRatePercentage.ToString("G3")), null, TaleWorlds.CampaignSystem.Overlay.GameOverlays.MenuOverlayType.SettlementWithCharacters); //TODOW

            //Deposit Menu
            campaignGameStarter.AddGameMenu("altdorf_bank_deposit", String.Format("Solde : {0}\nTaux d'intérêts : {1}%/jour", currentSolde, interestRatePercentage.ToString("G3")), null, TaleWorlds.CampaignSystem.Overlay.GameOverlays.MenuOverlayType.SettlementWithCharacters); //TODOW

            //Withdraw Menu
            campaignGameStarter.AddGameMenu("altdorf_bank_withdraw", String.Format("Solde : {0}\nTaux d'intérêts : {1}%/jour", currentSolde, interestRatePercentage.ToString("G3")), null, TaleWorlds.CampaignSystem.Overlay.GameOverlays.MenuOverlayType.SettlementWithCharacters); //TODOW
